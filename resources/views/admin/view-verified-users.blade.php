        ...
        <div class="container">
            <div class="row">
                ...
                <div class="add-event-wrap clearfix">
                    <a href="{{url('admin/add-user')}}" class="btn btn-primary col-xs-2 text-center">Add User</a>
                    <form action="{{url('admin/search-verified-users')}}" method="post" class="search-form col-xs-5 no-pad push-xs-1">
...
<?php foreach ($users as $key => $user):?>
                        <tr>
                            ...
                            <td>
                                    <a href="{{url('admin/edit-verified-user/'.Crypt::encrypt($user->id))}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
