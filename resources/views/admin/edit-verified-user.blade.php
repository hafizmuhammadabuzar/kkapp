                    ...
                    <form action="{{ url('admin/update-user') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="field-wrap clearfix">
                            ...
                            <div class="right left-right">
                                ...
                                <div class="radio-wrap">
                                    <input type="radio" id="male" name="gender" value="Male" <?php if ($user->gender != 'Female' || $user->gender == 'Male') {echo 'checked="checked"';}?> required="required">
                        ...
                        <div class="field-wrap clearfix">
                            ...
                            <div class="right left-right">
                                <h4>User Verified</h4>
                                <div class="radio-wrap">
                                    <input type="radio" id="verified" name="verified" value="1" <?php if ($user->is_verified == 1) {echo 'checked="checked"';}?> required="required">
                                    <label for="yes">Yes</label>
                                </div>
                                <div class="radio-wrap">
                                    <input type="radio" id="verified" name="verified" value="0" <?php if ($user->is_verified != '1' || $user->is_verified == 0) {echo 'checked="checked"';}?> required="required">
