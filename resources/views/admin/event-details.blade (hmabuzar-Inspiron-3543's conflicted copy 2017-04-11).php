...
?>
							...
							@if(!isset($event))
								@for ($loc = 1; $loc < count($old_cities); $loc++)
									<li>
									<a href="#" class="add-location">{{$old_locations[$loc].', '.$old_cities[$loc]}}<a/>
									<a href="#" class="link-remove fa fa-remove"></a>
									</li>
								@endfor
							@else
								...
								$latlng .= '~'.$loc->latlng; 
								?>
									<li><a href="#" class="add-location">{{$loc->location.', '.$loc->city}}<a/>
									<a href="#" class="link-remove fa fa-remove"></a>
									</li>
								@endforeach
							@endif
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.form-location').submit(function(){
			...
			$('.location-list').append('<li><a href="#" class="add-location">'+$('#event-location').val()+', '+$('#event-city').val()+'<a/><a href="#" class="link-remove fa fa-remove location-remove"></a></li>');
